...
<div class="bbb nav-scroller py-1 mb-2 ">
  <nav class="nav d-flex justify-content-between" >
    <a class="p-2 nav_css" onclick="location.href='<%= request.getContextPath() %>/board1Kor.bo'">한식</a>
    <a class="p-2 nav_cssSelect" onclick="location.href='<%= request.getContextPath() %>/board2Ch.bo'">중식</a>
  ...
  <div class="cardBox" id="cardBoxDetail">
    ...
    <div class="cardBoxText">
      <div class="card-body">
        ...
        <span class="reviewDate justify-content-center" style="width:5%"><%= list.get(0).getBoardDate() %><!-- 글쓴날짜 --></span><!-- /if문 넣어서 수정하면 modify_date로 -->
    ...
    <div class="cardBox" id="cardBoxDetail">
      <div class="cardImg">
        <img src="<%= request.getContextPath() %>/images/review02 zzangjangmen.png" class="img-fluid img_cut"  alt="짜장면집 리뷰">
      </div>
      <div class="cardTxt">
        <div class="card-body">
          ...
          <span class="reviewDate justify-content-center" style="width:5%"><%= list.get(1).getBoardDate() %><!-- 글쓴날짜 --></span>
    ...
    <div class="cardBox" id="cardBoxDetail">
    <div class="">
      <img src="<%= request.getContextPath() %>/images/review03-1 rubijung.png" class="img-fluid img_cut"  alt="루비정 리뷰">
    </div>
    <div class="cardBoxText">
      <div class="card-body">
        ...
        <span class="reviewDate justify-content-center" style="width:5%"><%= list.get(2).getBoardDate() %><!-- 글쓴날짜 --></span>
    ...
    <div class="cardBox" id="cardBoxDetail">
      <div class="">
        <img src="<%= request.getContextPath() %>/images/review04 arachai.png" class="img-fluid img_cut"  alt="아라차이 리뷰">
      </div>
      <div class="">
        <div class="card-body">
        ...
        <span class="reviewDate justify-content-center" style="width:5%"><%= list.get(3).getBoardDate() %><!-- 글쓴날짜 --></span>
...
<div class="pagingArea" align="center">
			...
			<% for(int p = pi.getStartPage(); p <= pi.getEndPage(); p++){ %>
				...
				<% } else{ %>
					<button type="button" class="btn btn-sm Writing2" id="numBtn" onclick="location.href='<%= request.getContextPath() %>/board2Ch.bo?currentPage=<%= p %>'"><%= p %></button>
				<% } %>
			<% } %>
			
			<!-- 다음 페이지로 -->
			<button type="button" class="btn btn-sm Writing" onclick="location.href='<%= request.getContextPath() %>
				/board2Ch.bo?currentPage=<%= pi.getCurrentPage()+1 %>'" id="afterBtn"> &gt; </button>
				<script>
			...
			<!-- 맨 마지막으로 -->
			 <button type="button" class="btn btn-sm Writing" onclick="location.href='<%= request.getContextPath() %>/board2Ch.bo?currentPage=<%= pi.getLastPage() %>'"> &gt;&gt; </button>
...
<script>
  $(function(){
    $('#cardBoxDetail *').mouseenter(function(){
      ...
      var num1 = <%= list.get(0).getBoardNo() %>; 

      location.href = '<%= request.getContextPath() %>/detail.bo?no=' + num1;
    });
  });
</script>

// js val() elementbyId등 값 가져올 수 있음
