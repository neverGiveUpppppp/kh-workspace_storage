...
<link href="bootstrap-5.1.3-examples/blog/blog.css" rel="stylesheet">
	...
	<main class="container"> 
	  <div class="boardform_area">
	    <form action="<%= request.getContextPath() %>/insert.no1" method="post" style="padding: 0 10px;">
	      <!-- 제목 -->
	      ...
	      <div class="form-group row mb-2">
	        ...
	        <div class="col-sm-10">
	         <%= loginUser.getUserName() %>
	          <input type="hidden" class="form-control" id="writer" name="writer" value="<%= loginUser.getUserName() %>">
	        </div>
	      </div>
<!-- 	      <div class="form-group row mb-2">
