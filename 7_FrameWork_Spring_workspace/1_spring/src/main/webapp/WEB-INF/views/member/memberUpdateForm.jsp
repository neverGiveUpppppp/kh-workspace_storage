	...
	<div class="centerText">
		<form action="mupdate.me" method="post">
			<table>
				...
				<tr>
					<th>이름</th>
					<td><input type="text" name="name" value="${ loginUser.name }"></td> <!-- input text박스 안에 value값이 들어가있는 상태가 됨 -->
				</tr>
				<tr>
					<th>닉네임</th>
