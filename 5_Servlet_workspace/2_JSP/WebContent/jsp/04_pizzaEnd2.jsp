...
// PizzaServlet2.java에서 토핑이랑 사이드 가격 메뉴 코드에 			// (if문+for문+switch문)? 
// str을 감싸서 넣었기에 아래에서 if문으로 없다 있다면 표시해주면 됨
if(toppings.equals("")){
	toppings = "(없음)"; 
}
if(sides.equals("")){
...
// PizzaServlet2.java에서 전부 str 타입으로 보내왔기에 여기서 받는 것도
// 전부 str로 강제형변환해서 받음
%>   
...
<body>
	...
	<!-- 1과2의 차이는 전처리하느냐 후처리하느냐 차이 -->
	
	<h1>주문 내역</h1>
    <h2>
    	피자는<span style="color: red;"><%= pizza %></span>,
		토핑은<span style="color: green;"></span>,
		사이드는<span style="color: blue;"><%= sides %></span> 주문하셨습니다.
	</h2>
	...
	<h2>총합 : <span style="text=decoration: underline;"><%= total %>원</span></h2>
...
<%-- 		
		...
		사이드는<span style="color: blue;"></span> 주문하셨습니다.
		<%
			if(sides != null){
