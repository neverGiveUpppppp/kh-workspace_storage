...
<div class="cardContainer">
  ...
  <div class="cardBox" id="cardBoxDetail">
    <div class="">
      <img src="<%= request.getContextPath() %>/images/logo.png" class="img-fluid img_cut"  alt="맛집 리뷰">
    </div>
    ...
    <div class="cardBox" id="cardBoxDetail">
      <div class="cardImg">
        <img src="<%= request.getContextPath() %>/images/logo.png" class="img-fluid img_cut"  alt="맛집리뷰">
      </div>
      <div class="cardTxt">
        <div class="card-body">
    ...
    <div class="cardBoxText">
      <div class="card-body">
        ...
        <span class="reviewDate justify-content-center" style="width:5%"><%= list.get(2).getBoardDate() %><!-- 글쓴날짜 -->로</span>
