	...
	<div class="container">
	  ...
	  <div class="nav-scroller py-1 mb-2">
	    <nav class="nav d-flex">
	      ...
	      <a class="p-2 link-secondary" onclick="location.href='<%= request.getContextPath() %>/board2Ch.bo'">중식</a>
	      <a class="p-2 link-secondary" onclick="location.href='<%= request.getContextPath() %>/board3West.bo'">양식</a>
	      <a class="p-2 link-secondary" onclick="location.href='<%= request.getContextPath() %>/board4Jp.bo'">일식</a>
	      <a class="p-2 link-secondary" onclick="location.href='<%= request.getContextPath() %>/board5Des.bo'">디저트</a>
