 ...
 */
@WebServlet("/IdcheckEmail.me")
public class IdCheckEmailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IdCheckEmailServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String title = "[대한민국 대표 맛집 커뮤니티 맛조!]" + selectMember.getUserName() + " 회원님의 ID찾기 결과 안내";
		String content = "<div style='background:white; width:100%; height:100%;'><b>" + selectMember.getUserName() + " 회원님의 ID는 <span style='color:red;'>" + selectMember.getUserId()+ " 입니다.</span></b>"
				+ " 항상 저희 맛조를 이용하여주시는 회원 여러분들께 <br>감사의 말씀을 드리며 앞으로도 변함없는 최고의 서비스를 제공해 드리기위해 최선을 다하겠습니다.";
